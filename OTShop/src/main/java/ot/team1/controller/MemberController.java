...
public class MemberController {
	...
	public @ResponseBody String kakaostart() {
		String a = "<script type='text/javascript'>" + "location.href='https://kauth.kakao.com/oauth/authorize?"
				+ "client_id=904cba975ef71bec9a2a57539968e40a" + "&redirect_uri=http://localhost:8070/kakaoLogin"
...
// ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 카카오 로그인 끝 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
	...
	public String join(@ModelAttribute("dto") @Valid MemberVO membervo, BindingResult result,
			...
			@RequestParam(value = "repwd", required = false) String repwd, Model model) {
