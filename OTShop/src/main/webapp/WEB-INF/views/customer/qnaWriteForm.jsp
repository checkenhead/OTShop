    ...
    <form method="post" action="qnaWrite" name="qnaWriteFrm" class="faqFrm">
    	<div class="qnaViewCnt">
    		...
    		<div class="qnaViewSubs">
				...
				<div class="SubsSubs">
					<div><input type="text" name="title" id="qnaTitle"></div><br>
					<div>
           			...
           			<div><input type="text" id="qnaUserid" name="userid" value="${userid}" readonly></div><br>
           			<div><input name="secret" type="checkbox" value="Y">비밀글로 하기</div><br>
           			<div><textarea rows="8" cols="65" name="content"></textarea></div><br>
				</div>
    		</div>
    	</div><br><br>
