...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=460b902d624b97dd59686611e337cc74"></script>

<div class="faqWrap">

	<form id="qnaList" class="faqFrm">
		...
		<div class="listBody">
			<br> <br>
			<h3>인사말</h3>
			<br> 저희 쇼핑몰을 방문해 주셔서 감사드립니다. 저희 쇼핑몰은 회원제를 실시하고 있습니다.<br> 처음
			오신 분은 먼저 회원가입을 하신 후 이용하시길 바랍니다.<br> <br>
			<h3>배송 방법은 택배입니다.</h3>
			<br> 주문하신 날로부터 3 ~ 6일 안에 받을 수 있습니다.<br> - 온라인 입금 시 입금 확인 후
			3 ~ 6일<br> - 신용카드 결제 시 주문 후 3 ~ 6일<br> <a href="shopMap">오프라인
				매장</a>도 운영하고 있으니 많은 관심 부탁드립니다.<br> <br>
			<h3>BANK ACCOUNT</h3>
			<br> 예금주 : ㈜옷샵<br> <br> 신한은행 1005-601-776813<br>
		...
		<div class="maplistBody">
			<fieldset class="introMap">
				<legend>지 도</legend>
				<div id="map" style="width: 800px; height: 500px;"></div>


				<script type="text/javascript"
					src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6c463d8600c99a1eaaad8d0d62b71308"></script>
				<script>
					...
					// 마커가 표시될 위치입니다 
					var markerPosition = new kakao.maps.LatLng(37.545990,
							127.061773);
