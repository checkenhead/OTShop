		...
		<div class="maplistBody">
			<fieldset class="introMap">
				...
				<script>
					...
					// 마커가 표시될 위치입니다 
					var markerPosition = new kakao.maps.LatLng(37.555306,
							126.922369);
				...
				<div class="introMapSubs">
					🚎 지하철 : 홍대입구역 9번 출구에서 도보 5분<br>
					<br> 🚍 버&nbsp;스 : 271번, 273번, 301번 외 다수
				</div>
			</fieldset>
		</div>
		<br>
		...
		<div class="maplistBody">
			<fieldset class="introMap">
				...
				<script>
					...
					// 마커가 표시될 위치입니다 
					var markerPosition2 = new kakao.maps.LatLng(35.154646,
							129.059390);
				...
				<div class="introMapSubs">
					🚎 지하철 : 서면역 2번 출구에서 도보 10분<br>
					<br> 🚍 버&nbsp;스 : 169-1번, 33번, 133번 외 다수
				</div>
			</fieldset>
		</div>
